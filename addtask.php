...
if(isset($_POST['addtask']))
{
    ...
    $taskdatetime=$date->format('Y-m-d H:i:s a');
    $status="no";
        $insertquery = "INSERT INTO task(employeeid,taskdetails,taskdatetime,status) VALUES ('$employeeid','$taskdetails','$taskdatetime','$status')";
...
<head>
    ...
    <title>Add Task | Appeal Guru</title>
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: var(--bs-orange);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="addtask.php"><i class="fas fa-plus"></i><span>Add task</span></a></li>
...
<?php }} ?>
                ...
                <div class="container-fluid" data-aos="fade" data-aos-duration="1500" data-aos-once="true">
                    ...
                    <div class="card shadow card-employee">
                        ...
                        <div class="card-body">
                            <form method="post">
                                <select class="form-control" aria-expanded="false" data-bs-toggle="dropdown" id="teammember" name="teammember" required>
                                        <option class="dropdown-item" value="0">--Select Option--</option>
                                        <?php
                                        $result=mysqli_query($con,"select employeeid,employeename,teamid from employee
                        ...
                        echo "<option class='dropdown-item' value=$employeeid>$employeename</option>";
                                ...
                                <textarea class="form-control" placeholder="Task description" name="task" required></textarea>    
                                <button class="btn btn-primary" type="submit" name="addtask" style="background: var(--bs-orange);">Add task</button></form>
                        </div>
                    </div> 
                    <div class="card shadow card-employee">
                        <div class="card-header py-3">
    ...
    if (td) {
      ...
      if (txtValue.toUpperCase().indexOf(filter) > -1) {
        ...
        tr[i].style.display = "none";
                            ...
                            <div class="table-responsive table mt-2" id="dataTable-1" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody id="dataTable1">
                                        ...
                                        $result=mysqli_query($con,"select * from task LIMIT $start_from, $limit")or die ("query 1 incorrect.....");
                        ...
                        <td><a href='addtask.php?id=$id&action=delete'><button style='background: var(--bs-orange);' class='btn btn-primary delete' type='button' ><span><i class='fa fa-trash'></i></span></button></a></td></tr>";
                        }}else {

                            $result=mysqli_query($con,"select * from task where id='$taskid'")or die ("query 1 incorrect.....");
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link' href='addtask.php?page=".$i."'>".$i."</a></li>";   
}
echo $pagLink . "</ul>";  
?>
                                    </nav>
