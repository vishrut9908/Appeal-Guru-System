    ...
    <div class="modal fade" id="delete_room" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><span class="fas fa-remove"></span> Cancel</button>
                    <button type="submit" class="btn btn-danger" id="confirm_delete"><span class="fas fa-check"></span> Delete</button>
					...
					<div class="form-group input-group">
						...
						<select style="width:350px;" class="form-control" name="user">
							...
							include('db.php');
								...
								$u=mysqli_query($conn,"select * from client where clientid not in ('".$users."')");
								...
								while($urow=mysqli_fetch_array($u)){
									?>
										<option value="<?php echo $urow['employeeid']; ?>"><?php echo $urow['employeename']; ?></option>	
									<?php
								}
								}
...
<div class="modal fade" id="delete_member" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><span class="fas fa-remove"></span> Cancel</button>
                    <button type="submit" class="btn btn-primary"><span class="fas fa-check"></span> Delete</button>
					</form>
                </div>
            </div>
            <!-- /.modal-content -->
