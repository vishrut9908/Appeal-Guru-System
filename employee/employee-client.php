...
<head>
    ...
    <title>Client | Appeal Guru</title>
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: var(--bs-orange);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="employee-client.php"><i class="fa fa-handshake-o"></i><span>Employee's Client</span></a><a class="nav-link" href="employee-attendance.php"><i class="far fa-clock"></i><span>Attendance</span></a></li>
                            ...
                            <div class="table-responsive table mt-2" id="dataTable-1" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody id="dataTable1">
                                            ...
                                            <?php
                                            $id=$_SESSION['id'];
                                        $result=mysqli_query($con,"select employeeclient.id,employee.employeename,client.clientname from employeeclient inner join employee inner join client on employee.employeeid = employeeclient.employeeid and client.clientid = employeeclient.clientid where employee.employeeid='$id' LIMIT $start_from, $limit")or die ("query 1 incorrect.....");
...
<?php
$id=$_SESSION['id'];
$result_db = mysqli_query($conn,"select count(employeeclient.id) from employeeclient inner join employee inner join client on employee.employeeid = employeeclient.employeeid and client.clientid = employeeclient.clientid where employee.employeeid='$id'"); 
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link' href='employee-client.php?page=".$i."'>".$i."</a></li>";   
}
echo $pagLink . "</ul>";  
?>
                                    </nav>
