...
$name=$_POST['name'];
$email=$_POST['email'];
mysqli_query($con,"update employee set employeename='$name', email='$email' where employeeid='$id'")or die("Query 2 is inncorrect..........");
...
mysqli_query($con,"update employee set password='$password' where employeeid='$id'")or die("Query 3 is inncorrect..........");
...
$insertquery = "update employee set profilepic='$image' where employeeid='$id'";
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: var(--bs-orange);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="employee-profile.php"><i class="fas fa-user"></i><span>Profile</span></a></li>
                                    ...
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                            <form action="" method="post">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="name"><strong>Name</strong></label><input class="form-control" type="text" name="name" id="username" placeholder="Name" value="<?php echo $name1;?>" name="username" required></div>
                                                    </div>
                                                    <div class="col">
                                                ...
                                                <div class="mb-3"><button class="btn btn-primary btn-sm" type="submit" name="updateprofile">Save Settings</button></div>
                                            </form>
                                        </div>
                                    </div>
                                    <div class="card shadow">
                                        ...
                                        <div class="card-body">
                                            <form action="" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="password"><strong>Password</strong></label><input class="form-control" type="password" id="password" placeholder="New password" name="password" required></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="confirmpassword"><strong>Confirm Password</strong></label><input class="form-control" type="password" id="confirmpassword" placeholder="Confirm New password" name="confirmpassword" required></div>
                                                    </div>
                                                </div>
                                                <div class="mb-3"><button class="btn btn-primary btn-sm" type="submit" name="updatepassword">Save&nbsp;Settings</button></div>
                                            </form>
                                        </div>
                                    </div>
                                </div>
