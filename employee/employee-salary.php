        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: var(--bs-orange);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="employee-salary.php"><i class="fas fa-file-invoice-dollar"></i><span>Salary</span></a></li>
...
<?php }} ?>
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Salary</h3>
      ...
      if (txtValue.toUpperCase().indexOf(filter) > -1) {
        ...
        tr[i].style.display = "none";
                        ...
                        echo "<tr><td>$id</td><td>$employeeid</td><td>$employeename</td>
                                            ...
                                            <td><a href='payslip.php?id=$id&eid=$employeeid&action=view'><button class='btn btn-primary' type='button' ><span><i class='fa fa-money'></i></span></button></a></td></tr>";
                        }?>
                                    </tbody>
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link' href='employee-salary.php?page=".$i."'>".$i."</a></li>";   
}
echo $pagLink . "</ul>";  
?>
                                    </nav>
