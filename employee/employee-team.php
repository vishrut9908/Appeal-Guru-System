...
<head>
    ...
    <title>Team Members | Appeal Guru</title>
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: var(--bs-orange);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="employee-team.php"><i class="fa fa-group"></i><span>Team Members</span></a></li>
...
<?php }} ?>
                ...
                <div class="container-fluid" data-aos="fade" data-aos-duration="1500" data-aos-once="true">
                    <h3 class="text-dark mb-4">Team Members</h3>
                    <div class="card shadow card-employee">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Team Member Info</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-2">
                            ...
                            <div class="table-responsive table mt-2" id="dataTable-1" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody id="dataTable1">
                                       <?php
                                       $id=$_SESSION['id'];
                                        $result=mysqli_query($con,"select employeeid,employeename,type from employee where teamid=(select teamid from employee where employeeid='$id') LIMIT $start_from, $limit ")or die ("query 1 incorrect.....");

                        while(list($employeeid,$employeename,$type)=mysqli_fetch_array($result))
                        { 
                        echo "<tr><td>$employeeid</td><td>$employeename</td><td>$type</td>
                        </tr>";
                        }?>
                                    </tbody>
                                </table>
...
<?php
$id1=$_SESSION['id'];
$result_db = mysqli_query($conn,"SELECT COUNT(employeeid) FROM employee where teamid=(select teamid from employee where employeeid='$id1')"); 
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link' href='employee-team.php?page=".$i."'>".$i."</a></li>";   
}
echo $pagLink . "</ul>";  
?>
                                    </nav>
