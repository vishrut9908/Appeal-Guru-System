...
<body style="background: rgb(255,255,255);width: 597px;height: 800px;margin: auto;" id="content">
    <div id="content3">
...
return $words;
    ...
    <a href="employee-salary.php"><button style="margin-left: 35%;" >Back</button></a>
