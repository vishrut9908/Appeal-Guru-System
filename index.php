...
end as pal FROM attendance where pal='present' or pal='absent' group by pal ";
                ...
                <div class="container-fluid">
                            ...
                            <div class="card shadow border-start-primary py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>Total employees</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span>
                                                <?php  $query = "SELECT employeeid FROM employee"; 
                                      $result = mysqli_query($con, $query); 
                                       if ($result) 
                        { 
                            // it return number of rows in the table. 
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-success py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>Total Clients</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span>
                                                <?php  $query = "SELECT clientid FROM client"; 
                                      $result = mysqli_query($con, $query); 
                                       if ($result) 
                        { 
                            // it return number of rows in the table. 
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-info py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-info fw-bold text-xs mb-1"><span>Active Employees</span></div>
                                            <div class="row g-0 align-items-center">
                                                <div class="col-auto">
                                                    <div class="text-dark fw-bold h5 mb-0 me-3"><span>
                                                        <?php  $query = "SELECT employeeid FROM employee where status='Active now'"; 
                                      $result = mysqli_query($con, $query); 
                                       if ($result) 
                        { 
                            // it return number of rows in the table. 
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-warning py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-warning fw-bold text-xs mb-1"><span>Active Clients</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span>
                                            <?php  $query = "SELECT clientid FROM client where status='Active now'"; 
                                      $result = mysqli_query($con, $query); 
                                       if ($result) 
                        { 
                            // it return number of rows in the table. 
                    ...
                    <div class="row">
                        <div class="col-lg-7 col-xl-8">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="text-primary fw-bold m-0">Attendance Overview</h6>
                        ...
                        <div class="col-lg-5 col-xl-4">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="text-primary fw-bold m-0">Tickets record</h6>
                                </div>
                                <div class="card-body">
                    ...
                    <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="text-primary fw-bold m-0">Holiday List</h6>
                                </div>
                                <ul class="list-group list-group-flush" style="height: 200px;overflow:auto ;">
                                <?php
                                $sql_con = new mysqli('localhost', 'root', '', 'appealgurustaff');

if($stmt = $sql_con->prepare("SELECT holidaydate, holidayfor FROM holiday")) {
   $stmt->execute(); 
   $stmt->bind_result($holidatdate, $holidayfor);
$h=0;
   while ($stmt->fetch()) {
                            ?>
                                    ...
                                    <li class="list-group-item">
                                        <div class="row align-items-center no-gutters">
                                            <div class="col me-2">
                                                <h6 class="mb-0"><strong><?php echo "$holidayfor"; ?></strong></h6><span class="text-xs"><?php echo "$holidatdate"; ?></span>
                                            </div>
                    ...
                    <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="text-primary fw-bold m-0">Task List</h6>
                                </div>
                                <ul class="list-group list-group-flush" style="height: 200px;overflow:auto ;">
                                <?php
                                $sql_con = new mysqli('localhost', 'root', '', 'appealgurustaff');
   ...
   while ($stmt->fetch()) {
                            ?>
                                    ...
                                    <li class="list-group-item">
                                        <div class="row align-items-center no-gutters">
                                            <div class="col me-2">
                                                <h6 class="mb-0"><strong><?php echo "$taskdetails"; ?></strong></h6><span class="text-xs"><?php echo "$taskdatetime"; ?></span>
                                            </div>
                    ...
                    <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="text-primary fw-bold m-0">Ticket List</h6>
                                </div>
                                <ul class="list-group list-group-flush" style="height: 200px;overflow:auto ;">
                                <?php
                                $sql_con = new mysqli('localhost', 'root', '', 'appealgurustaff');

if($stmt = $sql_con->prepare("SELECT description,employeename FROM tickets where employeename = ? ")) {
   ...
   while ($stmt->fetch()) {
                            ?>
                                    ...
                                    <li class="list-group-item">
                                        <div class="row align-items-center no-gutters">
                                            <div class="col me-2">
                                                <h6 class="mb-0"><strong><?php echo "$description"; ?></strong></h6><span class="text-xs"><?php echo "$employeename"; ?></span>
                                            </div>
