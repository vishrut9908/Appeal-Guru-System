...
<head>
    ...
    <title>Attendance | Appeal Guru</title>
...
<?php }} ?>
                ...
                <div class="container-fluid" data-aos="fade" data-aos-duration="1500" data-aos-once="true">
                    <h3 class="text-dark mb-4">Employee's Attendance</h3>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Employee's Attendance Info</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="text-md-end dataTables_filter" id="dataTable_filter"><label class="form-label"><input type="date" class="form-control form-control-sm" aria-controls="dataTable" placeholder="Search" id="searchfilter" onkeyup="myFunction()" ></label></div>
                                </div>
                            </div>
                            <script>
function myFunction() {
                            ...
                            <div class="table-responsive table mt-2" id="dataTable-1" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody id="dataTable1">
                                        <?php
                                        $id=$_SESSION['id'];
                                        $result=mysqli_query($con,"select * from attendance where employeeid='$id'")or die ("query 1 incorrect.....");

                        while(list($id,$day,$pal)=mysqli_fetch_array($result))
                        { 
                        echo "<tr><td>$id</td><td>$day</td><td>$pal</td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <nav class="d-lg-flex justify-content-lg-end dataTables_paginate paging_simple_numbers">
                                        <?php
                                        $id=$_SESSION['id'];
$result_db = mysqli_query($conn,"SELECT COUNT(id) FROM attendance where employeeid='$id'"); 
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link' href='manager-employee-attendance.php?page=".$i."'>".$i."</a></li>";   
}
echo $pagLink . "</ul>";  
?>
                                    </nav>
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">All Employee's Attendance</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-2">
        ...
        tr[i].style.display = "none";
                            ...
                            <div class="table-responsive table mt-2" id="dataTable-1" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody id="dataTable2">
                                        <?php
                                        $result=mysqli_query($con,"select attendance.id,attendance.day,attendance.pal,employee.employeename from attendance inner join employee on employee.employeeid = attendance.employeeid LIMIT $start_from, $limit")or die ("query 1 incorrect.....");

                        while(list($id,$day,$pal,$employeename)=mysqli_fetch_array($result))
                        { 
                        echo "<tr><td>$id</td><td>$day</td><td>$pal</td><td>$employeename</td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <nav class="d-lg-flex justify-content-lg-end dataTables_paginate paging_simple_numbers">
                                        <?php
$result_db = mysqli_query($conn,"SELECT COUNT(id) FROM attendance"); 
$row_db = mysqli_fetch_row($result_db);  
$total_records = $row_db[0];  
$total_pages = ceil($total_records / $limit); 
/* echo  $total_pages; */
