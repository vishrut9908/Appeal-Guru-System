...
$id=$_GET['id'];
/*this is delet query*/
mysqli_query($con,"delete from review where id='$id'")or die("query is incorrect...");
}
$limit = 10;  
if (isset($_GET["page"])) {
    $page  = $_GET["page"]; 
...
<head>
    ...
    <title>Reviews | Appeal Guru</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Client Reviews Info</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-2">
        ...
        tr[i].style.display = "none";
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody id="dataTable1">
                                        <?php
                                        $result=mysqli_query($con,"select * from review LIMIT $start_from, $limit")or die ("query 1 incorrect.....");

                        while(list($id,$clientid,$reviewfor,$reviewforname,$review,$reviewdate)=mysqli_fetch_array($result))
                        { 
                        echo "<tr><td>$id</td><td>$clientid</td><td>$reviewfor</td>
                        <td>$reviewforname</td><td>$review</td><td>$reviewdate</td>
                            <td><a href='manager-reviews.php?id=$id&action=delete'><button class='btn btn-primary delete' type='button' ><span><i class='fa fa-trash'></i></span></button></a></td>
                        </tr>";
                        }?>
                                    </tbody>
                                </table>
...
<?php
$result_db = mysqli_query($conn,"SELECT COUNT(id) FROM review"); 
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link' href='manager-reviews.php?page=".$i."'>".$i."</a></li>";   
}
echo $pagLink . "</ul>";  
?>
                                    </nav>
